...
>
                    ...
                    <button
                      type="submit"
                      className="inline-flex w-full items-center justify-center rounded-2xl border border-[#E7E2D6]/25 bg-[#E7E2D6] px-6 py-4 text-sm font-medium text-[#18191B] transition duration-200 hover:bg-white hover:brightness-110 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.45),0_0_28px_rgba(255,255,255,0.18)]"
                    >
                      Отправить заявку
                    </button>
                  </form>
